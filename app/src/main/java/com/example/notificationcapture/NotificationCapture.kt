...
/**
 * Application class - initialize NotificationCapture here.
 */
class CaptureApp : Application() {
    override fun onCreate() {
        super.onCreate()
        NotificationCapture.init(this)

        // Register providers (in real app, get credentials from BuildConfig or secure storage)
        // NotificationCapture.get().registerProvider(SlackProvider(this, "client_id", "client_secret"))
        // NotificationCapture.get().registerProvider(MSTeamsProvider(this, "client_id"))
    }
}
